    ...
    return (
      <div className="max-w-6xl mx-auto p-6 min-h-[60vh] flex items-center justify-center relative z-10">
        <div className="glass-card-strong p-12 text-center max-w-md">
          ...
          <p className="text-[#2D2D2D]/80 mb-8 text-lg">Connect your wallet to use the x402 FHE demo.</p>
  ...
  return (
    <div className="max-w-6xl mx-auto p-6 space-y-6 relative z-10">
      ...
      <div className="text-center mb-10">
        <h1 className="text-5xl font-bold mb-4 text-[#2D2D2D] tracking-tight">x402 FHE Demo</h1>
        <p className="text-xl text-[#2D2D2D]/70">Interact with the x402 FHE confidential token contract</p>
      </div>
